...
export const metadata: Metadata = {
  ...
  description: "Zyorix Terms of Service covering engagement scope, fees, confidentiality, liability, and governing law (England & Wales).",
  alternates: { canonical: "/terms" },
  robots: { index: true, follow: true },
};

const toc = [
    { name: "Services & Engagement", href: "#services" },
    { name: "Fees & Payment", href: "#fees" },
    { name: "Client Responsibilities", href: "#responsibilities" },
    { name: "Confidentiality", href: "#confidentiality" },
    { name: "Data Protection", href: "#data" },
    { name: "Intellectual Property", href: "#ip" },
    { name: "Warranties & Disclaimers", href: "#warranties" },
    { name: "Liability", href: "#liability" },
    { name: "Term & Termination", href: "#termination" },
...
export default function TermsPage() {
  return (
    <main id="main" className="prose prose-neutral mx-auto max-w-3xl px-4 py-12">
      ...
      <nav>
        <h2 className="text-base font-medium">On this page</h2>
        <ul className="not-prose list-none p-0">
            {toc.map(item => (
                <li key={item.href}><a href={item.href} className="text-blue-600 underline underline-offset-2 hover:no-underline">{item.name}</a></li>
            ))}
        </ul>
      </nav>

      <h2 id="services">1. Services &amp; Engagement</h2>
      <p>
      ...
      <h2 id="data">5. Data Protection</h2>
      <p>
      ...
      <h2 id="warranties">7. Warranties &amp; Disclaimers</h2>
      <p>
