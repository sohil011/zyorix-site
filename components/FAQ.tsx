...
export default function FAQ({ qa = defaultQA, title = "FAQ" }: FAQProps) {
  const [open, setOpen] = useState<number | null>(0);
  return (
    <section aria-labelledby="faq-title" className="py-10 md:py-14">
      <div className="mx-auto max-w-6xl px-4">
        <h2 id="faq-title" className="text-xl font-semibold text-neutral-900 dark:text-white text-center">{title}</h2>
