    ...
    <section className="relative isolate bg-gradient-to-r from-white via-gray-50 to-blue-50">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-20 lg:px-6 lg:py-24">
        ...
        <div className="mt-7 flex flex-wrap justify-center gap-3 sm:mt-8">
          <Link prefetch={false}
            href="/contact"
            className="inline-flex items-center justify-center rounded-xl bg-blue-700 px-5 py-3 text-white hover:bg-blue-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700 focus-visible:ring-offset-2 min-w-[180px]"
            data-ga-event="cta_click"
            data-ga-label="hero_discovery_call"
          >
            Book a discovery call
          </Link>
          <Link prefetch={false}
            href="/case-studies"
            className="inline-flex items-center justify-center rounded-xl border border-gray-300 px-5 py-3 text-gray-900 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700 focus-visible:ring-offset-2 min-w-[180px]"
            data-ga-event="cta_click"
            data-ga-label="hero_case_studies"
          >
            See case studies
          </Link>
        </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white/70 p-3 shadow-sm backdrop-blur-sm sm:p-5 lg:p-8">
            <div className="grid gap-3 sm:grid-cols-2 sm:gap-4">
              <a
                ...
                className="rounded-xl bg-gray-100 p-3 hover:bg-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-700 sm:p-4"
              >
